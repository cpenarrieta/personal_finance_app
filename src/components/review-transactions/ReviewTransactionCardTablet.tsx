...
interface ReviewTransactionCardTabletProps {
...
export function ReviewTransactionCardTablet({
  transaction,
  edit,
  categories,
  tags,
  ...
  onUpdateEdit,
  onFlipAmount,
}: ReviewTransactionCardTabletProps) {
