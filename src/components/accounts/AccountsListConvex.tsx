...
/**
 * Client Component for accounts list using Convex
 * Fetches and groups accounts by institution
 */
export function AccountsListConvex() {
  const accounts = useQuery(api.accounts.getAllWithInstitution)
