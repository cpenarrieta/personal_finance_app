    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-xl group-data-[variant=floating]:border group-data-[variant=floating]:shadow-md dark:bg-gradient-to-b dark:from-sidebar dark:to-sidebar/95"
        >
          {children}
        </div>
      </div>
