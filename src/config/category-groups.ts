 ...
 * Each category name should match the exact name in the database (CustomCategory.name)
 *
 ...
 */
export function getCategoryGroup(categoryName: string): CategoryGroupType | null {
