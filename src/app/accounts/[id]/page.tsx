...
export default async function AccountDetailPage({
  ...
  const isInvestmentAccount =
    account.type === "investment" || account.subtype?.includes("brokerage");
      ...
      <div className="mb-6 p-6 border rounded-lg bg-white shadow-md">
          ...
          {account.availableBalance !== null && (
            <div className="bg-green-50 rounded-lg p-4 border border-green-200">
              ...
              <div className="text-2xl font-bold text-green-900">
                $
                {parseFloat(account.availableBalance).toLocaleString("en-US", {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
                })}
              </div>
        ...
        {account.balanceUpdatedAt && (
          <div className="text-xs text-gray-500 mt-4">
            ...
            {format(new Date(account.balanceUpdatedAt), "MMM d yyyy h:mm a")}
          </div>
        )}
      </div>
