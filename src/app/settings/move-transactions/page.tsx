...
export default function MoveTransactionsPage() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <h1 className="text-2xl font-semibold mb-6">Move Transactions Between Categories</h1>
      ...
      {showTransactions && (
        <>
          ...
          <div className="border rounded-lg p-6 mb-6">
            ...
            {transactions.length === 0 ? (
              <p className="text-gray-500">No transactions found for this category/subcategory.</p>
            ) : (
          ...
          {transactions.length > 0 && selectedTransactionIds.size > 0 && toCategoryId && (
            <div className="border rounded-lg p-6 mb-6 bg-blue-50">
              ...
              <p className="mb-4">
                ...
                {toSubcategoryId && (
                  <> ({toCategory?.subcategories.find((s) => s.id === toSubcategoryId)?.name})</>
                )}
              </p>
