      ...
      <div className="max-w-5xl mx-auto p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">
            Organize your categories into custom groups for better financial
            tracking
          </p>
        </div>
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-500">
                          {group.items.length === 0
                            ? "No categories"
                            : `${group.items.length} category${
                                group.items.length > 1 ? "ies" : ""
                              }`}
                        </p>
                      </div>
                      <DeleteButton
                        id={group.id}
                        action={deleteGroup}
                        confirmMessage={`Are you sure you want to delete the group "${
                          group.name
                        }"?${
                          group.items.length > 0
                            ? ` This will remove ${group.items.length} category(ies) from this group.`
                            : ""
                        }`}
