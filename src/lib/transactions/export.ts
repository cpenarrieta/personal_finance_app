 ...
 */
export async function downloadTransactionsCSV(transactionIds: string[]): Promise<void> {
 ...
 */
export async function copyTransactionsForGoogleSheets(transactionIds: string[]): Promise<void> {
